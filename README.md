...
```bash
# x86_64
curl -L -o logview.tar.gz https://gitee.com/Mtok/logview/releases/download/v0.12.7/logview_linux_amd64.tar.gz
tar xzf logview.tar.gz && rm logview.tar.gz
sudo mv logview /usr/local/bin/

# ARM64
curl -L -o logview.tar.gz https://gitee.com/Mtok/logview/releases/download/v0.12.7/logview_linux_arm64.tar.gz
tar xzf logview.tar.gz && rm logview.tar.gz
sudo mv logview /usr/local/bin/
